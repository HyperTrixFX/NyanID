...
//
//    public ForgetPasswordAPI(AccountsRepository accountsRepository, EmailService emailService, RedisService redisService, StrictIpResolver strictIpResolver) {
...
//                            String pwd = utilset.HMACSHA256(encryptionKey, newpwd);
