...
import moe.koseirin.nyanruaineo.utils.Command.CommandList.*;
...
public class CmdMain {
    ...
    public CmdMain(RedisCommand redisCommand, UserManagerCommand userManagerCommand, SystemctlCommand systemctlCommand) {
